...
- **Efficiency**: Across 6 benchmark repos (390 runs), Lore-enabled agents use 29% fewer tokens and 40% fewer tool calls compared to grep + file-read baselines, with an 11pp higher success rate.
