...
const FASTAPI_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    '1.4': { symbol: 'solve_dependencies', file: 'fastapi/dependencies/utils.py', expectedAnswer: 'dependencies/utils.py\nrouting.py\nget_request_handler\nget_route_handler', expectedAnswerParts: ['routing.py', 'get_request_handler', 'solve_dependencies'], expectedSymbols: ['solve_dependencies'], expectedFiles: ['fastapi/dependencies/utils.py', 'fastapi/routing.py'] },
    // ── New: call-graph + snippet ──
    ...
    '11.2': { symbol: 'solve_dependencies', file: 'fastapi/dependencies/utils.py', expectedAnswer: 'app → routing.py\nsolve_dependencies\nawait solve_dependencies', expectedAnswerParts: ['app', 'routing.py', 'solve_dependencies', 'await solve_dependencies'], expectedSymbols: ['solve_dependencies'], expectedFiles: ['fastapi/dependencies/utils.py', 'fastapi/routing.py'] },
...
const ESBUILD_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    '1.2': { symbol: 'rebuildImpl', file: 'pkg/api/api_impl.go', expectedAnswer: 'NewStderrLog\nRealFS\nScanBundle\nCompile\nLink', expectedAnswerParts: ['ScanBundle', 'Compile', 'Link'], expectedSymbols: ['rebuildImpl'], expectedFiles: ['pkg/api/api_impl.go'] },
    ...
    '1.8': { symbol: 'Build', file: 'pkg/api/api.go', expectedAnswer: 'Handle:\nrunImpl\nPropagate:\nhandleBuildRequest', expectedAnswerParts: ['Handle', 'runImpl', 'Propagate', 'handleBuildRequest'], expectedSymbols: ['Build', 'runImpl'], expectedFiles: ['pkg/api/api.go', 'pkg/cli/cli_impl.go', 'cmd/esbuild/service.go'] },
    '7.2': { symbol: 'MakeLineColumnTracker', file: 'internal/logger/logger.go', expectedAnswer: 'parseFile → internal/bundler/bundler.go\nTokenize → internal/css_lexer/css_lexer.go\nParse → internal/css_parser/css_parser.go\nNewLexer → internal/js_lexer/js_lexer.go\nnewParser → internal/js_parser/js_parser.go\nParseJSON → internal/js_parser/json_parser.go\nParseSourceMap → internal/js_parser/sourcemap_parser.go\nparseImportsExportsMap → internal/resolver/package_json.go\nParseTSConfigJSON → internal/resolver/tsconfig_json.go\ncompileYarnPnPData → internal/resolver/yarnpnp.go\nparseMangleCache → pkg/cli/mangle_cache.go', expectedAnswerParts: ['parseFile', 'bundler.go', 'Tokenize', 'css_lexer.go', 'Parse', 'css_parser.go', 'NewLexer', 'js_lexer.go', 'ParseJSON', 'json_parser.go', 'ParseSourceMap', 'sourcemap_parser.go'], expectedSymbols: ['MakeLineColumnTracker', 'parseFile', 'NewLexer', 'ParseJSON'], expectedFiles: ['internal/logger/logger.go', 'internal/bundler/bundler.go', 'internal/js_lexer/js_lexer.go', 'internal/js_parser/json_parser.go'] },
    '7.3': { symbol: 'Build', file: 'pkg/api/api.go', expectedAnswer: 'contextImpl → pkg/api/api_impl.go\nRebuild → pkg/api/api_impl.go\nDispose → pkg/api/api_impl.go', expectedAnswerParts: ['contextImpl', 'Rebuild', 'api_impl.go'], expectedSymbols: ['Build', 'contextImpl', 'Rebuild'], expectedFiles: ['pkg/api/api.go', 'pkg/api/api_impl.go'] },
    '10.1': { symbol: 'MakeLineColumnTracker', file: 'internal/logger/logger.go', expectedAnswer: '15\nparseFile → internal/bundler/bundler.go\nTokenize → internal/css_lexer/css_lexer.go\nParse → internal/css_parser/css_parser.go\nNewLexer → internal/js_lexer/js_lexer.go\nnewParser → internal/js_parser/js_parser.go\nParseJSON → internal/js_parser/json_parser.go\nParseSourceMap → internal/js_parser/sourcemap_parser.go\nparseImportsExportsMap → internal/resolver/package_json.go\nParseTSConfigJSON → internal/resolver/tsconfig_json.go\ncompileYarnPnPData → internal/resolver/yarnpnp.go\nparseMangleCache → pkg/cli/mangle_cache.go', expectedAnswerParts: ['parseFile', 'bundler.go', 'NewLexer', 'js_lexer.go', 'ParseJSON', 'json_parser.go', 'ParseSourceMap', 'sourcemap_parser.go', 'parseMangleCache'], expectedSymbols: ['MakeLineColumnTracker', 'parseFile', 'NewLexer', 'ParseJSON'], expectedFiles: ['internal/logger/logger.go', 'internal/bundler/bundler.go', 'internal/js_lexer/js_lexer.go', 'internal/js_parser/json_parser.go', 'internal/js_parser/sourcemap_parser.go'] },
    '10.3': { symbol: 'MakeLineColumnTracker', file: 'internal/logger/logger.go', expectedAnswer: 'Parser initialization\nparseFile\nNewLexer\nnewParser\nTokenize\nParse\nJSON/config parsing\nParseJSON\nParseTSConfigJSON\nparseImportsExportsMap\nParseSourceMap\ncompileYarnPnPData\nparseMangleCache', expectedAnswerParts: ['parseFile', 'NewLexer', 'ParseJSON', 'ParseTSConfigJSON', 'ParseSourceMap', 'parseMangleCache'], expectedSymbols: ['MakeLineColumnTracker', 'parseFile', 'ParseJSON'], expectedFiles: ['internal/logger/logger.go', 'internal/bundler/bundler.go', 'internal/js_parser/json_parser.go'] },
    '11.2': { symbol: 'ParseJSON', file: 'internal/js_parser/json_parser.go', expectedAnswer: 'ParseDefineExpr in internal/js_parser/js_parser.go\nParseSourceMap in internal/js_parser/sourcemap_parser.go\nanalyzeMetafileImpl in pkg/api/api_impl.go\nparseMangleCache in pkg/cli/mangle_cache.go', expectedAnswerParts: ['ParseDefineExpr', 'js_parser.go', 'ParseSourceMap', 'sourcemap_parser.go', 'analyzeMetafileImpl', 'api_impl.go', 'parseMangleCache', 'mangle_cache.go'], expectedSymbols: ['ParseJSON', 'ParseDefineExpr', 'ParseSourceMap', 'analyzeMetafileImpl', 'parseMangleCache'], expectedFiles: ['internal/js_parser/json_parser.go', 'internal/js_parser/js_parser.go', 'internal/js_parser/sourcemap_parser.go', 'pkg/api/api_impl.go', 'pkg/cli/mangle_cache.go'] },
    '11.3': { symbol: 'ParseJSON', file: 'internal/js_parser/json_parser.go', expectedAnswer: 'no\n4\nParseJSON\nParseDefineExpr\nParseSourceMap\nanalyzeMetafileImpl\nparseMangleCache\njs_parser.go\nsourcemap_parser.go\napi_impl.go\nmangle_cache.go', expectedAnswerParts: ['no', 'ParseJSON', 'ParseDefineExpr', 'ParseSourceMap', 'analyzeMetafileImpl', 'parseMangleCache'], expectedSymbols: ['ParseJSON', 'ParseDefineExpr', 'ParseSourceMap'], expectedFiles: ['internal/js_parser/json_parser.go', 'internal/js_parser/js_parser.go', 'internal/js_parser/sourcemap_parser.go', 'pkg/api/api_impl.go', 'pkg/cli/mangle_cache.go'] },
  },
};
