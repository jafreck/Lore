...
const LORE_SELF_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    '1.1': { symbol: 'openDb', file: 'src/db/schema.ts', expectedAnswer: 'build\nupdate\ningestSummary\ningestCoverage', expectedSymbols: ['openDb', 'build', 'update'], expectedFiles: ['src/indexer/index.ts', 'src/cli.ts'] },
    ...
    '1.8': { symbol: 'openDb', file: 'src/db/schema.ts', expectedAnswer: 'Handle:\nNone\nPropagate:\nbuild\nupdate\ningestSummary\ningestCoverage', expectedSymbols: ['openDb', 'build', 'update'], expectedFiles: ['src/indexer/index.ts'] },
    '7.2': { symbol: 'openDb', file: 'src/db/schema.ts', expectedAnswer: 'build → src/indexer/index.ts\nupdate → src/indexer/index.ts\ningestSummary → src/cli.ts\ningestCoverage → src/cli.ts', expectedSymbols: ['openDb', 'build', 'update'], expectedFiles: ['src/db/schema.ts', 'src/indexer/index.ts', 'src/cli.ts'] },
...
const ZOD_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    '1.2': { symbol: 'parse', file: 'packages/zod/src/v4/core/parse.ts', expectedAnswer: '_parse\n_zod_output\naddIssueToContext', expectedSymbols: ['parse', '_parse'], expectedFiles: ['packages/zod/src/v4/core/parse.ts'] },
    '1.4': { symbol: '_parse', file: 'packages/zod/src/v4/core/parse.ts', expectedAnswer: 'core.ts\nparse.ts\nschemas.ts\napi.ts', expectedSymbols: ['_parse'], expectedFiles: ['packages/zod/src/v4/core/parse.ts'] },
    // ── New: call-graph + snippet ──
    '1.3': { symbol: 'parse', file: 'packages/zod/src/v4/core/parse.ts', expectedAnswer: '_parse\naddIssueToContext\nschema\nvalue\nctx', expectedSymbols: ['parse', '_parse', 'addIssueToContext'], expectedFiles: ['packages/zod/src/v4/core/parse.ts'] },
    '1.5': { symbol: '_parse', symbol2: 'addIssueToContext', file: 'packages/zod/src/v4/core/parse.ts', expectedAnswer: 'parse', expectedSymbols: ['_parse', 'addIssueToContext', 'parse'], expectedFiles: ['packages/zod/src/v4/core/parse.ts'] },
    ...
    '11.3': { symbol: '_parse', file: 'packages/zod/src/v4/core/parse.ts', expectedAnswer: 'no\n_parse\nparse\nrecursive', expectedSymbols: ['_parse', 'parse'], expectedFiles: ['packages/zod/src/v4/core/parse.ts'] },
  },
};
...
const FASTAPI_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    // ── New: call-graph + snippet ──
    '1.3': { symbol: 'add_api_route', file: 'fastapi/routing.py', expectedAnswer: 'get_value_or_default\nAPIRoute\ngenerate_unique_id\nroute_class\npath\nendpoint', expectedSymbols: ['add_api_route', 'APIRoute', 'generate_unique_id'], expectedFiles: ['fastapi/routing.py'] },
...
const ESBUILD_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    '1.5': { symbol: 'Build', symbol2: 'Serve', file: 'pkg/api/api.go', expectedAnswer: 'main\nBuild\nServe', expectedSymbols: ['Build', 'Serve'], expectedFiles: ['pkg/api/api.go', 'cmd/esbuild/main.go'] },
...
const POSTGRES_ANSWERS: RepoAnswers = {
  ...
  questions: {
    // ── Kept: pure call-graph ──
    '1.1': { symbol: 'parse_analyze_fixedparams', file: 'src/backend/parser/analyze.c', expectedAnswer: 'pg_analyze_and_rewrite_fixedparams', expectedSymbols: ['parse_analyze_fixedparams', 'pg_analyze_and_rewrite_fixedparams'], expectedFiles: ['src/backend/parser/analyze.c', 'src/backend/tcop/postgres.c'] },
    ...
    // ── New: call-graph + snippet ──
    '1.3': { symbol: 'pg_analyze_and_rewrite_fixedparams', file: 'src/backend/tcop/postgres.c', expectedAnswer: 'parse_analyze_fixedparams\npg_rewrite_query\npstate\nparseTree\nparamTypes', expectedSymbols: ['pg_analyze_and_rewrite_fixedparams', 'parse_analyze_fixedparams', 'pg_rewrite_query'], expectedFiles: ['src/backend/tcop/postgres.c'] },
    ...
    '1.8': { symbol: 'parse_analyze_fixedparams', file: 'src/backend/parser/analyze.c', expectedAnswer: 'Handle:\nNone\nPropagate:\npg_analyze_and_rewrite_fixedparams\nexec_simple_query\nSPI_execute', expectedSymbols: ['parse_analyze_fixedparams', 'pg_analyze_and_rewrite_fixedparams'], expectedFiles: ['src/backend/tcop/postgres.c', 'src/backend/parser/analyze.c'] },
    '7.2': { symbol: 'parse_analyze_fixedparams', file: 'src/backend/parser/analyze.c', expectedAnswer: 'pg_analyze_and_rewrite_fixedparams → postgres.c\nexec_simple_query → postgres.c', expectedSymbols: ['parse_analyze_fixedparams', 'pg_analyze_and_rewrite_fixedparams'], expectedFiles: ['src/backend/parser/analyze.c', 'src/backend/tcop/postgres.c'] },
    '7.3': { symbol: 'pg_analyze_and_rewrite_fixedparams', file: 'src/backend/tcop/postgres.c', expectedAnswer: 'parse_analyze_fixedparams → src/backend/parser/analyze.c\npg_rewrite_query → src/backend/rewrite/rewriteHandler.c', expectedSymbols: ['pg_analyze_and_rewrite_fixedparams', 'parse_analyze_fixedparams', 'pg_rewrite_query'], expectedFiles: ['src/backend/tcop/postgres.c', 'src/backend/parser/analyze.c'] },
