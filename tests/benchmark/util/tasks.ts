...
const POSTGRES_ANSWERS: RepoAnswers = {
  ...
  questions: {
    ...
    '1.6': { symbol: '', file: 'src/backend/parser/analyze.c', expectedAnswer: 'addNSItemForReturning', expectedAnswerParts: ['addNSItemForReturning'], expectedSymbols: [], expectedFiles: ['src/backend/parser/analyze.c'] },
    ...
    '8.1': { symbol: '', file: '', expectedAnswer: 'None', expectedAnswerParts: ['none'], expectedSymbols: [] },
    '9.1': { symbol: '', file: '', expectedAnswer: 'Added: None\nRemoved: None\nChanged: None', expectedAnswerParts: ['Added', 'Removed', 'Changed'], expectedSymbols: [] },
    '10.2': { symbol: '', file: 'src/backend/tcop/utility.c', expectedAnswer: '1. CreateCommandTag — 6 files: src/backend/commands/event_trigger.c, src/backend/commands/functioncmds.c, src/backend/commands/prepare.c, src/backend/executor/functions.c, src/backend/executor/spi.c, src/backend/tcop/postgres.c\n2. ProcessUtility — 6 files: src/backend/commands/extension.c, src/backend/commands/foreigncmds.c, src/backend/commands/schemacmds.c, src/backend/executor/functions.c, src/backend/executor/spi.c, src/backend/tcop/pquery.c\n3. PreventCommandIfReadOnly — 4 files: src/backend/commands/copy.c, src/backend/commands/sequence.c, src/backend/executor/execMain.c, src/backend/libpq/be-fsstubs.c', expectedAnswerParts: ['CreateCommandTag', 'ProcessUtility', 'PreventCommandIfReadOnly'], expectedSymbols: ['CreateCommandTag', 'ProcessUtility', 'PreventCommandIfReadOnly'], expectedFiles: ['src/backend/tcop/utility.c', 'src/backend/commands/extension.c', 'src/backend/tcop/pquery.c', 'src/backend/tcop/postgres.c'] },
